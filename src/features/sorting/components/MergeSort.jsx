...
import MergeSortVisualizer from "../../../dsa/sorting/merge/MergeSortVisualizer";
    ...
    <div className={`os-root ${isMobile ? 'mobile-os' : ''}`}>
      ...
      <div className="page-header-wrap">
        ...
        <div className={`flex flex-col gap-0 ${isMobile ? 'items-center text-center' : ''}`}>
          <span className="text-[10px] font-mono text-zinc-600 mb-2 tracking-tighter">REF: MERGE_SORT_CORE</span>
          
          <div className={`flex items-baseline ${isMobile ? 'flex-col items-center gap-2' : 'gap-4'}`}>
            <h1 className={`${isMobile ? 'text-3xl' : 'text-5xl'} font-black text-white tracking-widest`}>Merge-Sort</h1>
          ...
          <p className="mt-4 text-zinc-500 text-[11px] uppercase tracking-[0.3em] font-light">
            Recursive divide and conquer memory consolidation engine.
          </p>
        </div>
      </div>
      ...
      <section className="doc-section">
        <div>
          ...
          <p className="doc-text">
            Merge Sort is an efficient, general-purpose, and comparison-based sorting algorithm. Most implementations 
            produce a stable sort, which means that the order of equal elements is the same in the input and output. 

...
import BubbleSortVisualizer from "../../../dsa/sorting/bubble/BubbleSortVisualizer";
    ...
    <div className={`os-root ${isMobile ? 'mobile-os' : ''}`}>
      ...
      <div className="page-header-wrap">
        ...
        <div className={`flex flex-col gap-0 ${isMobile ? 'items-center text-center' : ''}`}>
          <span className="text-[10px] font-mono text-zinc-600 mb-2 tracking-tighter">REF: BUBBLE_SORT_CORE</span>
          
          <div className={`flex items-baseline ${isMobile ? 'flex-col items-center gap-2' : 'gap-4'}`}>
            <h1 className={`${isMobile ? 'text-3xl' : 'text-5xl'} font-black text-white tracking-widest`}>Bubble-Sort</h1>
          ...
          <p className="mt-4 text-zinc-500 text-[11px] uppercase tracking-[0.3em] font-light">
            Iterative comparison engine for linear data structures.
          </p>
        </div>
      </div>
      ...
      <section className="doc-section">
        <div>
          ...
          <p className="doc-text">
            ...
            comparing adjacent elements and swapping them if they are in the wrong order. The pass through the list 

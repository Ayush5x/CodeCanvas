  ...
  const ds2Algorithms = [
    {
      id: '01',
      title: "Bubble Sort",
      description: 'Repeatedly swaps adjacent elements if they are incorrectly ordered.',
      complexity: 'O(N²)',
      icon: <ArrowLeftRight />,
      features: ['Simplicity', 'In-Place', 'Stable'],
      link: '/dsa/sorting/bubble',
      status: 'available'
    },
    {
      id: '02',
      ...
      complexity: 'O(N²)',
      icon: <FaRocket />,
      features: ['Unstable Nature', 'Minimal Swaps', 'Simple'],
      link: '/dsa/sorting/selection',
      status: 'available'
    },
    {
      id: '03',
      title: "Insertion Sort",
      description: 'Builds the final sorted array one at a time.',
      complexity: 'O(N²)',
      icon: <ListPlus />,
      features: ['Adaptive', 'Stable', 'In-place'],
      link: '/dsa/sorting/insertion',
      status: 'available'
    },
    {
      id: '04',
      title: "Merge Sort",
      description: 'Divide and conquer recursive strategy.',
      complexity: 'O(N log N)',
      icon: <GitPullRequest />,
      features: ['Divide-and-conquer', 'Stable', 'External'],
      link: '/dsa/sorting/merge',
      status: 'available'
    },
    {
      id: '05',
      title: "Quick Sort",
      description: 'Efficient partitioning around a pivot.',
      complexity: 'O(N log N)',
      icon: <Zap />,
      features: ['Divide-and-conquer', 'Unstable', 'In-place'],
      link: '/dsa/sorting/quick',
      status: 'available'
    },
    {
      id: '06',
      title: "Heap Sort",
      description: 'Comparison-based sort using a binary heap.',
      complexity: 'O(N log N)',
      icon: <Activity />,
      features: ['Comparison-based', 'Unstable', 'In-place'],
      link: '/dsa/sorting/heap',
      status: 'available'
    },
        ...
        >
          <div>
            <div className="hud-badge" style={{ marginBottom: '10px' }}>
              <FaTerminal style={{ marginRight: '8px' }} /> Sorting Algo .
            </div>
            ...
            <p style={{ color: '#444', fontSize: isMobile ? '0.75rem' : '0.9rem', marginTop: '5px' }}>
              Sorting is the process of arranging a collection of data elements into a specific, logical order—typically numerical or alphabetical—to make searching and data management more efficient.
            </p>
          </div>

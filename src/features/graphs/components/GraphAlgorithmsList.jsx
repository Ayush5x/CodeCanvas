...
const graphCards = [
  ...
  },
  {
    ...
    description: 'Node-based hierarchy providing efficient sorted search and insertion operations. Core foundation for relational data storage.',
    icon: <FaTree />,
    route: '/dsa/graphs/bst',
    difficulty: 'BEGINNER',
    timeComplexity: 'O(LOG N)',
    features: ['#Recursive', '#Sorted', '#BinarySearch']
  },
];
    ...
    <div className="graph-home-container">
      <style>{`
        ...
        .graph-home-container {
          ...
          padding: ${isMobile ? '6rem 1rem 1rem 1rem' : '2rem'};
          display: flex;
        ...
        .navbar-wrapper {
          ...
          top: 0;
          z-index: 1000;
          margin-bottom: ${isMobile ? '4rem' : '5rem'};
        }

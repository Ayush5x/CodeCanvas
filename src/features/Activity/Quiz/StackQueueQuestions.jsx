...
const STACK_QUEUE_MASTER_DATA = [
  ...
  { id: 3, q: "What happens when you try to Pop from an empty stack?", options: ["Overflow", "Underflow", "Garbage Value", "Null Pointer"], correct: 1, logic: "Underflow occurs when an operation tries to remove an element from an empty structure." },
...
export default StackQueueQuestions;

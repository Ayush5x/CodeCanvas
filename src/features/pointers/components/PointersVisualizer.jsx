  ...
  return (
    <div className="os-pointers-layout">
      <style>{`
        ...
        .os-pointers-layout { 
          display: flex; flex-direction: column; gap: ${isMobile ? '15px' : '20px'}; color: white; 
        ...
        .top-header { 
          ...
          margin-bottom: ${isMobile ? '20px' : '20px'}; 
        }
        .tutorial-text { 
          font-size: ${isMobile ? '10px' : '11px'}; color: #9CA3AF; display: flex; align-items: center; gap: 8px; 
          background: rgba(255,255,255,0.03); padding: ${isMobile ? '10px 15px' : '10px 15px'}; border-radius: 12px; 
        ...
        .os-input, .os-select { 
          ...
          color: white; padding: ${isMobile ? '10px 15px' : '10px 15px'}; border-radius: 10px; font-family: 'Space Mono', monospace; 
          font-size: ${isMobile ? '11px' : '12px'}; outline: none; transition: all 0.3s ease; 
        }
        ...
        .os-btn { 
          ...
          color: #e0e0e0; padding: ${isMobile ? '10px 15px' : '10px 18px'}; border-radius: 10px; font-size: ${isMobile ? '10px' : '10px'}; 
        ...
        .code-block { 
          ...
          border: 1px solid rgba(255,255,255,0.03); font-size: ${isMobile ? '11px' : '11px'}; line-height: 1.6; 
        ...
        .canvas-container { min-height: 300px; height: ${isMobile ? '45vh' : '50vh'}; overflow: hidden; position: relative; }
        ...
        .doc-title { font-size: ${isMobile ? '16px' : '18px'}; color: #fff; margin-bottom: 20px; font-weight: 900; display: flex; align-items: center; gap: 12px; text-transform: uppercase; letter-spacing: 2px; }
        .doc-text { font-size: ${isMobile ? '13px' : '14px'}; color: #9CA3AF; line-height: 1.8; margin-bottom: 15px; }
      ...
      {/* Hero Section */}
      <div className={`relative ${isMobile ? 'pt-24 pb-8' : 'py-16'} flex flex-col items-center justify-center text-center overflow-hidden w-full`}>
        ...
        <div className="relative z-10 w-full px-4">
          ...
          <motion.h1 
            ...
            className={`${isMobile ? 'text-5xl' : 'text-8xl'} font-black tracking-tighter text-white uppercase italic leading-none`}
          >
          ...
          <motion.p 
            ...
            className={`mt-6 max-w-lg mx-auto text-zinc-400 ${isMobile ? 'text-[11px]' : 'text-sm'} leading-relaxed font-light tracking-wide px-2`}
          >

...
import { FaCode, FaTree, FaTools, FaMicrochip } from 'react-icons/fa';
import Header from '../../../components/Header';
import BstVisualizer from '../../../dsa/trees/bst/BstVisualizer';
        ...
        <div className="relative overflow-hidden w-full">
          ...
          <div className={`relative z-10 flex flex-col ${isMobile ? 'gap-4 items-center mt-8' : 'gap-6'}`}>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono tracking-[0.4em] text-zinc-500 uppercase">Hierarchy Sync Active</span>
            </div>
            ...
            <p className={`text-zinc-400 text-sm leading-relaxed ${isMobile ? 'border-t border-zinc-800 pt-4 px-2 max-w-[90%]' : 'max-w-md border-l-2 border-[#00f3ff]/30 pl-4'}`}>
              A recursive data structure optimized for logarithmic search operations. Every node maintains the invariant: Left Subtree &lt; Root &lt; Right Subtree.
            </p>
          </div>
        </div>
        ...
        <div className="content-wrap" style={{ marginTop: "50px" }}>
          ...
          >
            <div style={{ borderLeft: '4px solid #00f3ff', paddingLeft: '1.5rem', marginBottom: '3rem' }}>
              ...
              <p style={{ color: '#555', fontSize: '0.9rem' }}>Comprehensive breakdown of Binary Search Tree efficiency and logic synchronization.</p>
            </div>
            ...
            <div className="doc-grid" style={{ 
              ...
              <div className="doc-card">
                ...
                <h3 style={{ fontSize: '1rem', color: '#fff', marginBottom: '0.8rem' }}>ALGORITHM_SYNC</h3>
                <p style={{ fontSize: '0.85rem', color: '#666', lineHeight: '1.8' }}>
                  The visualizer utilizes <b>Async Generators</b> to synchronize code execution with tree traversal. Every yield statement pauses the algorithmic logic until the UI animation completes.
                </p>
              </div>
              ...
              <div className="doc-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '0.8rem', color: '#666' }}>Average Lookup</span>
              ...
              <div className="doc-card">
                ...
                <h3 style={{ fontSize: '1rem', color: '#fff', marginBottom: '0.8rem' }}>INDUSTRIAL_APPS</h3>
                <ul style={{ fontSize: '0.85rem', color: '#666', lineHeight: '1.8', paddingLeft: '1.2rem' }}>
                  <li><b>Database Indexing:</b> Optimized retrieval in high-concurrency environments.</li>
                  <li><b>File Systems:</b> Organizing hierarchical directory structures.</li>
                  <li><b>Compiler Design:</b> Efficient symbol table lookups.</li>
                </ul>
              </div>
            </div>
          </motion.section>

    ...
    <div className="os-container">
      <style>{`
        ...
        .os-container {
          ...
          /* Top padding accounts for the fixed Navbar and Header */
          padding: ${isMobile ? '100px 1rem 2rem 1rem' : '40px 1.5rem 1.5rem 1.5rem'};
          display: flex;
        ...
        .main-layout {
          display: grid;
          grid-template-columns: repeat(auto-fit, minmax(${isMobile ? '100%' : '320px'}, 1fr));
          gap: 20px;
          flex: 1;
        }
        ...
        .label { font-size: 9px; color: var(--accent); font-weight: bold; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 12px; opacity: 0.8; }
        ...
        .logic-line { font-size: ${isMobile ? '0.75rem' : '0.85rem'}; padding: 10px; border-radius: 10px; color: #777; transition: 0.3s; margin-bottom: 6px; }
        .logic-line.active { background: white; color: black; font-weight: bold; }

        .ram-footer { display: grid; grid-template-columns: repeat(auto-fill, minmax(${isMobile ? '110px' : '150px'}, 1fr)); gap: 10px; }
        .ram-slot { 
          padding: 12px; 
          border-radius: 14px; 
          border: 1px solid var(--glass-border); 
      ...
      <div className={`flex flex-col md:flex-row justify-between items-start md:items-center w-full border-b border-white/10 ${isMobile ? 'pb-6' : 'pb-10'} gap-6`}>
        <div className="relative overflow-hidden w-full">
          <h1 className={`absolute -top-10 -left-5 ${isMobile ? 'text-[6rem]' : 'text-[10rem]'} font-black text-white/[0.02] pointer-events-none select-none`}>
            LIST
          </h1>
          ...
          <div className="relative z-10 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono tracking-[0.4em] text-zinc-500 uppercase">System Active</span>
            </div>

            <div className="flex flex-col md:flex-row md:items-end gap-2">
              <h1 className={`${isMobile ? 'text-4xl' : 'text-7xl'} font-light tracking-tighter text-white`}>
                Single<span className={`font-black ${isMobile ? 'text-xl' : 'text-[25px]'} text-[#00ffcc]`}>_List</span>
              </h1>
            </div>

            <p className={`max-w-md text-zinc-400 ${isMobile ? 'text-xs' : 'text-sm'} leading-relaxed border-l-2 border-zinc-800 pl-4`}>

...
import StableRecursivePage from './StableRecursivePage';
...
function GreedyAlgorithms() {
  ...
  const algorithms = [
    ...
    {
      id: 'ALG-003',
      title: 'Stable Recursive (Activity Selection)',
      description: 'Select the maximum set of non-overlapping activities using a greedy recursive approach.',
      link: 'stable-recursive',
      complexity: 'O(N log N)',
      icon: <FaBalanceScale />,
      features: ['RECURSIVE_LOCK', 'ACTIVITY_SYNC', 'GREEDY_STABLE'],
      status: 'STABLE'
    },
  ];
      ...
      <div className="content-wrap">
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="stable-recursive" element={<StableRecursivePage />} />
          </Routes>
        </AnimatePresence>
      </div>
    </div>
